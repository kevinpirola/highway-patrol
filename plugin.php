...
wp_register_script('hp_jquery', '//code.jquery.com/jquery-3.2.1.slim.min.js');
...
function hp_plugin_menu() {
    ...
    add_submenu_page( 'hp-menu', 'Autostrade', 'Autostrade', 'manage_options', 'hp-menu-highways', 'hp_plugin_options');
...
function hp_plugin_options() {
    ...
    ?>
        <div class="container-fluid py-3">
            <h1>Gestione autostrade</h1>
            <p>In questa pagina puoi inserire i nuovi punti in interesse a riguardo delle autostrade e le nuove autostrde.</p>
            <hr>
            <h2>Autostrade</h2>
            <small>Inserisci, modifica o elimina le autostrade presenti</small>
            <div class="row py-3">
                <div class="col-md">
                    <button type="button" class="btn btn-outline-success mr-4">
                        <span class="highway-number">A27</span>
                    </button>
                    <button type="button" class="btn btn-outline-success mr-4">
                        <span class="highway-number">A4</span>
                    </button>
                </div>
            </div>
            <div class="row py-3">
